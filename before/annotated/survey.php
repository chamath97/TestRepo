...
if(isset($submit)&&(!$error)) { /* successful submission */ ?>
  ...
  if(!isset($submit)) {?>
          <span id="annot_link_01" class="annot_link next_sib" style="margin-left: -11.9em !important;padding-right: 11.2em;margin-top:5.2em;font-size:1.1em;"><a href="#annot_01" title="">01</a></span><?php
  } elseif($error) {?>
...
if(isset($submit)) {
  if(!$park) {?>
                          ...
                          <tr>
                            <th align="left" colspan="3"><span class="annot_link_parent">Which is your favorite city park?<?php if(!isset($submit)) {?><span id="annot_link_02" class="annot_link parent_node" style="margin-left: -13.6em !important;padding-right: 11.2em;margin-top:1em;"><a href="#annot_02" title="">02</a></span><?php }?></span></th>
                            <td height="31%"><IMG SRC="../img/gif.gif" alt="" height="25" width="5" border="0"></td>
                          </tr><?php
}?>
                          <tr height="72">
...
if(isset($submit)&&(!$city)) {?>
                          ...
                          <tr>
                            <td valign="middle" colspan="2"><span class="annot_link_parent"><?php if(!isset($submit)) {?><span id="annot_link_04" class="annot_link prev_sib" style="margin-left: -14.7em !important;padding-right: 13em;margin-top:0.2em;"><a href="#annot_04" title="">04</a></span><?php }?>
                                <select name="cc">
                                ...
                                </select><?php if(!isset($submit)) {?><span id="annot_link_05" class="annot_link next_sib" style="margin-left: -14.7em !important;padding-right: 20em;border-right: dashed blue 1px !important;height: .5em;margin-top:-1.5em;"><a href="#annot_05" title="">05</a></span><?php }?></span><IMG SRC="../img/gif.gif" alt="" height="25" width="5" border="0">
                                <p></p>
                            </td>
                          </tr>
                        </table>
  ...
  if(!$name) {?>
          ...
          <div style="clear:both;width:100%;padding:0px;margin:0px;">
            <div id="data" class="annot_link_parent"style="float:left">
              ...
              <span id="annot_link_07" class="annot_link prev_sib" style="margin-left: -13.25em !important;padding-right: 11.2em;margin-top:3.5em;"><a href="#annot_07" title="">07</a></span><?php }?>
            </div>
          </div>
          <p>&nbsp;</p></DIV>
        </TD>
